...
| 文档 | 说明 |
|------|------|
| [**docs/RAG_IMPROVEMENT_ROADMAP.md**](docs/RAG_IMPROVEMENT_ROADMAP.md) | 根因分析、Week 0–5+ 实施路线、答辩话术、里程碑表 |
...
答辩展示：启动前后端后打开 **`/eval`**，数据来自 `data/eval_baseline_report.json`（需先跑评测脚本生成）。
